...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Jan 2026 pada 23.02
...
CREATE TABLE `confirms` (
  ...
  `image` text NOT NULL,
  `status_order` varchar(255) NOT NULL DEFAULT 'NULL',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(6, '2025_03_25_020811_create_failed_jobs_table', 1),
(7, '2025_04_26_151323_create_orders_table', 1),
(8, '2025_04_26_151427_create_categories_table', 1),
(9, '2025_04_26_151502_create_products_table', 1),
(10, '2025_04_26_151550_create_orders_product_table', 1),
(11, '2025_04_26_151626_create_confirms_table', 1),
(12, '2025_04_26_152226_create_personal_accsess_token_table', 1),
(13, '2025_05_25_002414_add_order_id_to_orders_table', 1);
...
CREATE TABLE `orders` (
  ...
  `detail_status` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
--
-- Struktur dari tabel `personal_accsess_token`
--

CREATE TABLE `personal_accsess_token` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indeks untuk tabel `personal_accsess_token`
--
ALTER TABLE `personal_accsess_token`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `personal_accsess_token`
--
ALTER TABLE `personal_accsess_token`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
